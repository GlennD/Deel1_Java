                ...
                <div class="col col_13 container_buttons borderBottomTop" style="margin-left: 200px;">
                    ...
                    <%
                        ...
                        while (rs3.next()) {
                            ...
                            switch (facid) {
                                case 1:
                                    out.print("<div id='facility1' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/charge.png' /></div>");
                                    break;
                                case 2:
                                    out.print("<div id='facility2' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/drinking_water.png' /></div>");
                                    break;
                                case 3:
                                    out.print("<div id='facility3' class='masterTooltip' title= '" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/Black-Tap-Water-128.png' /></div>");
                                    break;
                                case 4:
                                    out.print("<div id='facility4' class='masterTooltip' title= '" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/shower.png' /></div>");
                                    break;
                                case 5:
                                    out.print("<div id='facility5' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/ehbo.png' /></div>");
                                    break;
                                case 6:
                                    out.print("<div id='facility6' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/Fast-Food-256.png' /></div>");
                                    break;
