...
<section class="row" id="grid">
        <h1><% out.print(festivalNaam); %> - Artists</h1><br />
...
%>
        ...
        <table class="festivalInfo">
            ...
            <tr><th colspan="2"><h2><%=rs1.getString("band_naam")%></h2></th></tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="festivalInfoSub">
                           <a href="<%=rs1.getString("band_url")%>"> <%=rs1.getString("band_url")%></a>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding-right: 20px;" colspan="2 "class="festivalInfoTitle">
                            <br/>
