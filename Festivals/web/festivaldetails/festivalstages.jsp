    ...
    <div class="col_16 col">
        ...
        <table class="oneFestival" style="background-color: #B8CFFF;" >
            <%
             ...
             <tr style="border: 0px solid black; "><th colspan="2" style="text-align: left; padding: 10px 50px 0px 10px;"><h1 style="font-family: algerian;"><%=rs1.getString("pod_omschr")%></h1> </th></tr>
<tr style="border: 0px solid black;"><td style="width: 300px; padding: 20px 50px 0px 20px;border: 0px solid black;"><h3 style="font-family: david ;">more info:   </h3></td><td><%=rs1.getString("pod_locatie")%></td></tr>
<tr style="border: 0px solid black;"><td style="width: 300px; padding: 20px 50px 0px 20px;border: 0px solid black;"><h3 style="font-family: david ;"><a href="bandsperstage.jsp?stageID=<%= rs1.getInt("pod_id") %>">Performing bands </a>  </h3></td><td></td></tr>
