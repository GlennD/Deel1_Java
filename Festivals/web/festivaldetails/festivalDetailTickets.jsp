...
%>
    ...
    <section class="row" id="grid">
        <h1 style="font-size: 55px;"><% out.print(festivalNaam); %> - Tickets</h1><br />
    ...
    <br />
    <p style="float:left; margin-bottom: 10px;">
    <a class="a_demo_three actief" href="festivalDetailTickets.jsp?festivalID=<% out.print(festivalID); %>" >
    Tickets
    </a>
    </p>
    </div>
