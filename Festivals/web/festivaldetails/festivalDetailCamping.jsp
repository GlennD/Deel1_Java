...
%>
    ...
    <section class="row" id="grid">
        <h1 style="font-size: 55px;"><% out.print(festivalNaam); %> - Campings</h1><br />
     ...
     <div class="row">
            <div class="col col_13 container_buttons" style="margin-left: 200px;">
                ...
                while(rs3.next()){
                   ...
                   switch(facid){
                       case 1: out.print("<div id='facility1' class='masterTooltip' title='" + rs3.getString("fac_omschr") +  "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/charge.jpg' /></div>");
                           break;
                       case 2: out.print("<div id='facility2' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/drinking_water.jpg' /></div>");
                           break;
                       case 3: out.print("<div id='facility3' class='masterTooltip' title= '" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/sink.png' /></div>"); 
                           break;
                       case 4: out.print("<div id='facility4' class='masterTooltip' title= '" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/shower.png' /></div>");
                           break;
                       case 5: out.print("<div id='facility5' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/ehbo.jpg' /></div>");
                           break;
                       case 6: out.print("<div id='facility6' class='masterTooltip' title='" + rs3.getString("fac_omschr") + "' style='float: left; margin-left: 20px;'><img style='width: 40px;' src='../images/eating.gif' /></div>");
                           break;
