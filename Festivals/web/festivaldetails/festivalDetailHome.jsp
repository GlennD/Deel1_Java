...
%>
   ...
   <section class="row" id="grid">
        <h1 style="font-size: 55px;"><% out.print(festivalNaam); %> - Home</h1><br />
         
    <div class="row">
    <div id="container_buttons" style="position: absolute; top: 80px;">
    <p style="float:left; margin-bottom: 10px;">
    <a class="a_demo_three actief" href="festivalDetailHome.jsp?festivalID=<% out.print(festivalID); %>">
    Home
    </a>
    </p>
    <br />
