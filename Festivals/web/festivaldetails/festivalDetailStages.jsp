 ...
 <div class="row">
            <div class="col col_13 container_buttons" style="margin-left: 200px;">
                <table class="festivalInfo">
                    <tr>
                        <td colspan="2"><%=rs1.getString("pod_omschr")%></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="festivalDetailBandsPerStage.jsp?stageID=<%=rs1.getString("pod_id")%>&festivalID=<% out.print(festivalID); %>">bekijk alle bands die op dit podium optreden</a>
                        </td>
                    </tr>
                </table>
            </div>
